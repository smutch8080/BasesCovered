...
export const EventList: React.FC<Props> = ({ date, events, onEventClick }) => {
  if (events.length === 0) {
    return (
    ...
    <div className="space-y-4">
      ...
      {events.map((event) => (
        <button
          ...
          className="w-full text-left block bg-gray-50 rounded-lg p-4 hover:bg-gray-100 transition-colors"
        >
